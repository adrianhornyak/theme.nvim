...
Group.link("NvimTreeGitFileDirty", g.Normal)
Group.link("NvimTreeGitFileStaged", g.Normal)
Group.link("NvimTreeGitFileMerge", g.Normal)
Group.link("NvimTreeGitFileRenamed", g.Normal)
Group.link("NvimTreeGitFileNew", g.Normal)
Group.link("NvimTreeGitFileDeleted", g.Normal)
